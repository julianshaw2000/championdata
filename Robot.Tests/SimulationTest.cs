...
{ 
        [Theory]
        [InlineData("PLACE 0,0,NORTH\nMOVE\nREPORT", "0,1,NORTH")]  // Robot should move north
        [InlineData("PLACE 0,0,NORTH\nLEFT\nREPORT", "0,0,WEST")]  // Robot should turn west
        [InlineData("PLACE 2,2,SOUTH\nMOVE\nMOVE\nREPORT", "2,0,SOUTH")]  // Robot should move south twice
        [InlineData("PLACE 2,2,SOUTH\nMOVE\nMOVE\nRIGHT\nREPORT", "2,0,WEST")] // Robot should move and turn right
        [InlineData("PLACE 2,2,SOUTH\nMOVE\nMOVE\nRIGHT\nMOVE\nREPORT", "1,0,WEST")] // Robot should move south 2, turn west, and move 1
        [InlineData("MOVE\nREPORT", Constants.UnplacedRobot)]  
        [InlineData("PLACE 0,0,NORTH\nLEFT\nMOVE\nREPORT", "0,0,WEST")]  // Robot should turn left
        [InlineData("PLACE 0,0,NORTH\nRIGHT\nMOVE\nREPORT", "1,0,EAST")] // Robot should turn right 
        [InlineData("PLACE 0,0,SOUTH\nLEFT\nMOVE\nREPORT", "1,0,EAST")] // Robot should  move
        [InlineData("PLACE 0,0,SOUTH\nRIGHT\nMOVE\nREPORT", "0,0,WEST")] // Robot should not move
        [InlineData("PLACE 0,0,NORTH\nRIGHT\nREPORT", "0,0,EAST")]  // Robot should turn right
        [InlineData("PLACE 4,4,NORTH\nRIGHT\nREPORT", "4,4,EAST")] // Robot should turn right
        [InlineData("PLACE 5,5,NORTH\nRIGHT\nREPORT", "5,5,EAST")] // Robot should turn right
